...
exports.Rect = function (props) { return function (context) {
...
exports.Polygon = function (props) { return function (context) {
    var ctx = context.ctx, frame = context.frame, camera = context.camera;
...
exports.Circle = function (props) { return function (context) {
    var ctx = context.ctx, frame = context.frame, camera = context.camera;
    // Don't bother drawing if its out of the scene.
...
exports.Line = function (props) { return function (context) {
    var ctx = context.ctx, frame = context.frame, camera = context.camera;
    // Don't bother drawing if its out of the scene.
    // if (!isRectVisible(lineBoundingRect(props), camera)) {
    //   return
    // }
    var a = worldToScreen(props.a, camera, frame);
    var b = worldToScreen(props.b, camera, frame);
    var z = frame.width / camera.width;
    var w = props.w * z;
    ctx.strokeStyle = props.color || 'black';
    ctx.lineWidth = w;
...
exports.Text = function (props) { return function (context) {
    var ctx = context.ctx;
...
exports.WorldText = function (props) { return function (context) {
    var ctx = context.ctx, frame = context.frame, camera = context.camera;
    // Don't bother drawing if its out of the scene.
    // if (!isRectVisible(lineBoundingRect(props), camera)) {
    //   return
