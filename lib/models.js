...
var Line = function (props) { return function (context) {
    var ctx = context.ctx, frame = context.frame, camera = context.camera;
    // Don't bother drawing if its out of the scene.
...
var WorldText = function (props) { return function (context) {
    var ctx = context.ctx, frame = context.frame, camera = context.camera;
    // Don't bother drawing if its out of the scene.
    // if (!isRectVisible(lineBoundingRect(props), camera)) {
    //   return
...
exports.default = { Rect: Rect, Polygon: Polygon, Circle: Circle, Line: Line, Text: Text, WorldText: WorldText };
